...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.DecimalField(decimal_places=2, default=2, max_digits=10, verbose_name='Стоимость с НДС '),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='expense',
            name='expense_vat',
            field=models.DecimalField(decimal_places=2, default=2, max_digits=10, verbose_name='Сумма НДС '),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='income',
        ...
        migrations.AddField(
            model_name='stock',
            name='expense_full_price',
            field=models.DecimalField(decimal_places=2, default=2, max_digits=10, verbose_name='Общая цена с ндс'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='stock',
        ...
        migrations.AddField(
            model_name='stock',
            name='product_price',
            field=models.DecimalField(decimal_places=2, default=2, max_digits=10, verbose_name='Общая цена без ндс'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='stock',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_price_vat', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Общая цена с НДС')),
                ('full_price', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Общая цена с ндс и надбавкой')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_vat', models.CharField(max_length=20, verbose_name='НДС')),
                ('product_extra', models.CharField(max_length=100, verbose_name='Надбавка')),
                ('total_price_expense', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Общая цена с НДС и надбавкой и количеством')),
                ('product_country', models.CharField(max_length=100, verbose_name='Страна товара')),
                ('product_barcode', models.CharField(max_length=100, verbose_name='Штрихкод товара')),
